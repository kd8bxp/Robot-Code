...
//This example found here: https://github.com/janisrove/Arduino-74HC595-shift-registers/tree/master/ArduinoLEDsWithShiftRegisters
//only the pins were changed for the rollbot
